...
exibe_Titulo('Lendo o Diretório de Dados...', COR_TITULO)
...
# QUESTÃO 01 - Item B
# Lendo os arquivos
exibe_Titulo('Lendo os Arquivos de INPUT...', COR_TITULO)
t_inicial = datetime.now()
lista_dados = list()
...
exibe_Titulo('Criando o Diretório de Estatísticas...', COR_TITULO)
t_inicial = datetime.now()
try:
    os.mkdir(DIR_ESTAT)
except:
...
exibe_Titulo('Salvando Arquivo de Consolidação...', COR_TITULO)
t_inicial = datetime.now()
...
exibe_Titulo('Preparando para Gerar as Estatísticas...', COR_TITULO)
t_inicial = datetime.now()
lista_bandeira = list()
lista_regiao   = list()
...
exibe_Titulo('Gerando as Estatísticas:', COR_TITULO)
exibe_Titulo('Bandeira x Produto x Ano x Valor Médio x Qt. Postos', COR_SUBTITULO)
t_inicial = datetime.now()
...
exibe_Titulo('Salvando Arquivo:', COR_SUBTITULO)
t_inicial = datetime.now()
